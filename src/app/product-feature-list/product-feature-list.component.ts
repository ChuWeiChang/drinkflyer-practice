...
export class ProductFeatureListComponent {
  ...
  items = [
    ...
    { id:3, description: 'Elevate your drinking ritual with bartender flavors expertly crafted with 5MG of Hemp-Derived THC.', btnText: 'savor sophistication', filename: 'Flyers_EdgeOff.png', },
  ];
}
