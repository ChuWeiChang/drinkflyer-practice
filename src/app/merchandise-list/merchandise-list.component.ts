...
export class MerchandiseListComponent {
  ...
  items = [
    ...
    { name: 'THC House Cocktail flight', review: 633, price:95, filename: 'FlyersNewCansHero2V3WEBSizing_2024-06-01T04_04_44.717Z.png', filenameOnHover: 'FlyersCocktailCoTHCCanFamily20240522WEBV2.png'},
    ...
    { name: 'THC Sunset Spritz - Party Pack', review: 633, price:95, filename: 'Sunset_Spritz_Family_Hero_-_4_-_WEB.png', filenameOnHover: 'Flyers_Cocktail_Co_Sunset_Spritz_THC_Can_Family_V1_-_WEB.png'},
  ];
}
